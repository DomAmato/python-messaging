...
class TestSmsSubmit(TestCase):
    ...
    def test_encoding_validity(self):
        # no validity
        number = binascii.unhexlify(b'2b3334363136353835313139')
        text = "hola"
    ...
    def test_encoding_class(self):
        number = binascii.unhexlify(b'2b3334363534313233343536')
        text = "hey yo"
    ...
    def test_encoding_ucs2_message(self):
        ...
        text = u"Русский"
        number = binascii.unhexlify(b'363535333435363738')
...
class TestSmsDeliver(TestCase):
    ...
    def test_decoding_ucs2_pdu(self):
        ...
        text = u"中兴通讯"
        csca = "+34607003110"
        number = binascii.unhexlify(b'2b3334363130373839373032')
    ...
    def test_decoding_datetime_gmtplusone(self):
        ...
        text = "  1741 bst"
        number = binascii.unhexlify(b'2b343437393137323637343130')
